...
$lst = $employee->findAll();


$dep = new Departement();
$dept = $dep->findById($_GET['id']);
?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid px-5 pt-3">
                    ...
                    <form class="user" method="post" action="departementUpdate.php?id=<?php echo $_GET['id']; ?>">
                        <div class="form-group row">

                            <div class="col-sm-6">
                                <input type="text" class="form-control form-control-user" id="exampleLastName" placeholder="Name" name="name" value="<?php echo $dept->name; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <select name="manager" id="manager" class="form-control">
                                    <option value="" selected disabled hidden>--Manager--</option>
                                    <?php
                                    foreach ($lst as $c) {
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <button type="submit" value="" class="btn btn-primary purple-color btn-user btn-block col-sm-6 mb-3 mb-sm-0" name="update-departement">Save</button>
                            </div>
