        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid px-5 pt-3">
                    ...
                    <form class="user" method="post" action="departementSave.php">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <button type="submit" value="" class="btn btn-primary purple-color btn-user btn-block col-sm-6 mb-3 mb-sm-0" name="save-departement">Save</button>
                            </div>
